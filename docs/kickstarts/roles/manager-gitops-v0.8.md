# MobiliPresenter — Manager / GitOps v0.8
...
ProjectMachine, RoutineInspection 0.1, Maintenance, SchedulerPlan e RuntimeCapabilityInspection são projections/artifacts derivados; não se tornam authority. Downstream não deve reobservar state silenciosamente nem reconstruir uma routine omitida para fabricar uma decisão.
