...
def inspect(items):
    return m.build_inspection(S,V,G,[C],project_machine_inspection_hash=SOURCE_HASH,remote_requested=False,pull_requests={"available":False,"reason":"NOT_REQUESTED","items":[]},coordination_state={"available":False,"reason":"NOT_REQUESTED","intents":[],"leases":[]},work_items=items)
