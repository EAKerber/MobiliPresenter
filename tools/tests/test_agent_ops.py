...
class GitOps12Tests(unittest.TestCase):
    def base_state(self):
        return {
            ...
            "git": {
                ...
                "protectedBranches": ["integration/viewer-parallel-v0.1", "ui/product-shell-v0.1"],
            },
    ...
    def test_state_shape_accepts_git_ops_12_active_development(self):
        self.assertEqual(project_state.validate_current(self.base_state()), [])

    def test_state_shape_accepts_between_increments(self):
        self.assertEqual(project_state.validate_current(self.between_increments_state()), [])
    ...
    def test_protected_parallel_branch_is_valid_context(self):
        ...
        self.assertEqual(check["status"], "PASS")
        self.assertEqual(check["context"], "protected-parallel")
