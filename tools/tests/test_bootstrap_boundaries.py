...
class BootstrapBoundaryTests(unittest.TestCase):
    def test_current_bootstrap_has_no_retired_operational_surfaces_or_delta_chain(self):
        ...
        v06 = (ROOT / "docs/kickstarts/roles/manager-gitops-v0.6.md").read_text(encoding="utf-8")
        combined = agents + "\n" + current + "\n" + v06
        for retired in ("maintenance_live.py", "scheduler_plan.py --live", "maintenance_inspect.py --remote"):
            self.assertNotIn(retired, combined)
        self.assertIn("manager-gitops-v0.6.md", current)
        self.assertNotIn("manager-gitops-v0.5.md", current)
        self.assertNotIn("manager-gitops-v0.4.md", current)
        self.assertNotIn("manager-gitops-v0.3.md", current)
        self.assertNotIn("manager-gitops-v0.5.md", v06)
        self.assertNotIn("manager-gitops-v0.4.md", v06)
        self.assertNotIn("manager-gitops-v0.3.md", v06)
