...
def command_git_mutation_plan(as_json,args):
    ...
    elif operation=="merge-pr":plan=git_mutation_plan.merge_pr(pr_number=_required(args.pr_number,"GIT_MUTATION_PR_NUMBER_REQUIRED"),head_sha=_required(args.head_sha,"GIT_MUTATION_PR_HEAD_SHA_REQUIRED"),base=_required(args.base,"GIT_MUTATION_PR_BASE_REQUIRED"),control_branch=control,merge_method=args.merge_method)
