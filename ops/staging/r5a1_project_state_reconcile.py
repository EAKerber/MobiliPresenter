...
CHECKPOINT = "M12-AT3D-R5A1-HOSTED-RUNTIME-OBSERVATION-INGRESS-QUALIFIED"
NEXT_TRANSITION = "resolve-m12-at3d-r5a2-work-mode-host-observation-surface-v0.1"
OUT = Path("/tmp/r5a1-project-state-reconcile")
...
def main() -> None:
    ...
    summary = {
        "schemaVersion": "R5A1ProjectStateReconcileQualification 0.1",
