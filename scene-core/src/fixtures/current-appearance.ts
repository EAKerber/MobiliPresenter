import type { AppearancePackage, ApplianceDefinition, MaterialDefinition } from "../contracts/appearance.js";
import {
...
export const currentAppearance: AppearancePackage = {
  ...
  applianceDefinitions: [
    ...
    appliance({
      id: "AP-TANK-01",
      role: "laundry-tank",
      appearanceFamily: "ceramic-pedestal-utility-sink",
      nominalAppearanceMm: { width: 500, height: 820, depth: 500 },
      fitPolicy: "fixture-adjustable-preserve-basin-language",
      assetPolicy: "parametric-preferred",
      requiredVisualFeatures: ["deep-rectangular-white-basin", "central-pedestal"],
      materialSlots: ["ceramic-white"],
      emitters: [],
    ...
    appliance({
      id: "AP-OVEN-01",
      role: "built-in-oven",
      appearanceFamily: "inox-60cm-dark-glass",
      nominalAppearanceMm: { width: 596, height: 596, depth: 575 },
      fitPolicy: "fit-to-slot-front-authoritative",
      assetPolicy: "normalized-external-allowed",
      requiredVisualFeatures: ["thin-inox-frame", "dark-glass-door", "horizontal-handle", "discreet-upper-controls"],
      materialSlots: ["inox-brushed", "black-glass"],
      emitters: [],
      sourceHints: ["Electrolux OE8 family official style anchor"]
    }),
    appliance({
      id: "AP-COOKTOP-01",
      role: "cooktop",
      appearanceFamily: "4-burner-black-glass",
      nominalAppearanceMm: { width: 600, height: 60, depth: 520 },
      fitPolicy: "top-surface-fit",
      assetPolicy: "parametric-preferred",
      requiredVisualFeatures: ["black-tempered-glass-top", "four-burners", "black-lightweight-grates"],
      materialSlots: ["black-glass", "dark-metal"],
      emitters: [],
      sourceHints: ["Electrolux KE4TP official style anchor"]
    }),
    appliance({
      id: "AP-HOOD-01",
      role: "hood",
      appearanceFamily: "built-in-slim-inox-60cm",
      nominalAppearanceMm: { width: 600, height: 215, depth: 298 },
      fitPolicy: "under-cab-fit",
      assetPolicy: "normalized-external-allowed",
      requiredVisualFeatures: ["slim-under-cab-body", "metal-filter", "brushed-inox", "task-led"],
      materialSlots: ["inox-brushed", "dark-metal"],
      emitters: [{
        id: "hood-task-led",
        type: "line",
        colorTemperatureK: 3200,
        relativeIntensity: 0.55,
        localPositionNormalized: [0.5, 0.55, 0.04],
        localDirection: { x: 0, y: 0, z: -1 }
      }],
      sourceHints: ["Electrolux DE6RX official dimensional/style anchor"]
    }),
    appliance({
      id: "AP-MICRO-01",
      role: "built-in-microwave",
      appearanceFamily: "black-glass-inox-60cm",
      nominalAppearanceMm: { width: 595, height: 389, depth: 393 },
      fitPolicy: "letterbox-allowed-within-slot",
      assetPolicy: "normalized-external-allowed",
      requiredVisualFeatures: ["large-dark-glass-door-left", "narrow-right-control-column", "subtle-inox-trim"],
      materialSlots: ["black-glass", "inox-brushed"],
      emitters: [],
      sourceHints: ["Electrolux ME3BP official dimensional/style anchor"]
    }),
    appliance({
      id: "AP-FRIDGE-01",
      role: "refrigerator",
      appearanceFamily: "inox-bottom-freezer-dispenser",
      nominalAppearanceMm: { width: 750, height: 1900, depth: 800 },
      fitPolicy: "fit-to-environment-envelope",
      assetPolicy: "normalized-external-allowed",
      requiredVisualFeatures: ["tall-silver-body", "two-horizontal-zones", "front-water-dispenser", "discreet-vertical-handles"],
      materialSlots: ["inox-brushed", "dark-plastic"],
      emitters: [],
      sourceHints: ["Electrolux TF39 official style cues; project envelope controls dimensions"]
    }),
    appliance({
      id: "FX-SINK-01",
      role: "kitchen-sink",
      appearanceFamily: "single-bowl-inox-undermount",
      nominalAppearanceMm: { width: 400, height: 180, depth: 340 },
      fitPolicy: "stone-cutout-dependent",
      assetPolicy: "parametric-preferred",
      requiredVisualFeatures: ["single-rectangular-bowl", "rounded-corners", "brushed-inox", "simple-arched-chrome-faucet"],
      materialSlots: ["inox-brushed", "chrome"],
      emitters: [],
      sourceHints: ["project style anchor; kitchen sink confirmed as present fixture"]
    })
  ],
  materials: [
